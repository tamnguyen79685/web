                            ...
                            <div class="card-header">
                                ...
                                <div style="float:right">
                                    <a role="button" class="btn btn-success delete-all"
                                        href="{{ url('admin/delete-all/answer') }}" record="answer">Delete
                                        All</a>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post"
                                                action="{{ route('admin.add-answer.question.exam', ['question_id' => $question_id, 'exam_id'=>$exam_id]) }}">
                                                @csrf
                                ...
                                <table id="questions-exam" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($answers as $i => $answer)
                                            <div class="modal fade" id="exampleModal{{$answer['id']}}" tabindex="-1" role="dialog"
                                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="post"
                                                                action="{{ route('admin.edit-answer.question.exam', ['answer_id' => $answer['id'], 'question_id' => $question_id, 'exam_id' => $exam_id]) }}">
                                                                @csrf
                                                                <div class="form-group">
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-size: 20px">
                                                    ...
                                                    data-target="#exampleModal{{$answer['id']}}"
                                                        href="{{ route('admin.edit-answer.question.exam', ['answer_id' => $answer['id'], 'question_id' => $answer['question_id'], 'exam_id' => $exam_id]) }}"><i
